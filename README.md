...
[![Download Burxat's Mixer for EarTrumpet](https://img.shields.io/badge/Download-Burxat's_Mixer_for_EarTrumpet-blue?style=for-the-badge&logo=windows)](https://github.com/Joanmarcgs/BurxatMixer-EarTrumpet/releases/latest)
...
1. Download and unzip the [latest release](https://github.com/Joanmarcgs/BurxatMixer-EarTrumpet/releases/latest) anywhere, e.g. `C:\Program Files\BurxatMixer`.
